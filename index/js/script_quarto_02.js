function salvar(){
localStorage.cliente_q_2 = document.getElementById("cliente_q_2").value;
localStorage.data_q_2 = document.getElementById("data_q_2").value;
...
localStorage.valor_q_2_h_q_2 = document.getElementById("valor_q_2_h").value;
...
localStorage.consumo_q_2_2 = document.getElementById("quant_q_2_2").value;
localStorage.quant_q_2_2 = document.getElementById("consumo_q_2_1").value;
...
function carregar(){
if (localStorage.cliente_q_2){
document.getElementById("cliente_q_2").value = localStorage.cliente_q_2;
document.getElementById("data_q_2").value = localStorage.data_q_2;
...
document.getElementById("valor_q_2_h").value = localStorage.valor_q_2_h;
